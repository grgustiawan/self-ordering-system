<template>
  ...
  .food-image-loaders .wrapper {
    width: 100%;
    height: 100%;
    position: relative;
  }
  
  .food-image-loaders .wrapper > div {
    background-color: #cacaca;
  }
  
  .food-image-loaders .circle {
    position: absolute;
    top: -10px;
    width: 65px;
    height: 65px;
