<template>
  ...
  <script>
  export default {
      name: 'CategoryLoaderVue'
  }
  </script>
  
  <style>
  .category-loaders:after {
    content: "";
    position: absolute;
    width: 100%;
    height: 100%;
  ...
  .category-loaders .wrapper {
    width: 100%;
    height: 100%;
    position: relative;
  }
  
  .category-loaders .wrapper > div {
  ...
  .category-loaders .button {
    display: inline-block;
    height: 32px;
    width: 75px;
  }
  
  .category-loaders .line-1 {
    position: absolute;
    top: 5px;
    left: 78px;
    height: 10px;
