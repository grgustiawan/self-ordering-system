<template>
  ...
  <script>
  export default {
      name: 'CategoryPageLoader'
  }
  </script>
  
  <style>
  .category-page-loaders {
    position: relative;
    width: 80%;
    height: 80px;
    margin-bottom: 10px;
  ...
  .category-page-loaders .wrapper {
    width: 100%;
    height: 100%;
    position: relative;
  }
  
  .category-page-loaders .wrapper > div {
    background-color: #cacaca;
  }
  
  .category-page-loaders .circle {
    position: absolute;
    top: -10px;
    width: 65px;
    height: 65px;
